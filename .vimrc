...
if filereadable(expand('~/dotfiles/vim/local.vim'))
  so ~/dotfiles/vim/local.vim
endif
if filereadable(expand('~/dotfiles/vim/generals.vim'))
  so ~/dotfiles/vim/generals.vim
endif
if filereadable(expand('~/dotfiles/vim/themes.vim'))
  so ~/dotfiles/vim/themes.vim
endif
