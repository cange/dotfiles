...
M.mappings = {
  language = {
    ...
    mappings = {
      ...
      q = { command = '<cmd>lua vim.diagnostic.setloclist()<CR>',               label = 'Quickfix' },
  ...
  search = {
    ...
    mappings = {
      ...
      w = { command = '<cmd>lua require("cange.telescope").find_workspace()<CR>', label = 'Workspace' },
      n = { command = '<cmd>lua require("cange.telescope").find_neovim()<CR>',    label = 'Neovim' },
      b = { command = '<cmd>lua require("cange.telescope").file_browser()<CR>',   label = 'Browse files' },
    },
  },
  ...
  config = {
    leader = 'c',
    mappings = {
      k = { command = '<cmd>e ~/.config/nvim/lua/cange/keybindings.lua<CR>',  label = 'Edit keybindings' },
      m = { command = '<cmd>e ~/.config/nvim/lua/cange/meta.lua<CR>',         label = 'Edit meta information' },
      o = { command = '<cmd>e ~/.config/nvim/lua/cange/options.lua<CR>',      label = 'Edit options' },
      p = { command = '<cmd>e ~/.config/nvim/lua/cange/plugins.lua<CR>',      label = 'Edit plugins' },
    },
  },
