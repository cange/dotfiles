  ...
  { -- bookmark buffers
    ...
    keys = function()
      ...
      return {
        ...
        { "<localleader>m1", function() harpoon:list():select(1) end, desc = "⇁ to 1st mark" },
        { "<localleader>m2", function() harpoon:list():select(2) end, desc = "⇁ to 2nd mark" },
        { "<localleader>m3", function() harpoon:list():select(3) end, desc = "⇁ to 3rd mark" },
        { "<localleader>m4", function() harpoon:list():select(4) end, desc = "⇁ to 4th mark" },
