...
using Context7 for library documentation and Exa for general queries.

## Search Tools Available

- **Context7**: Primary tool for library/framework documentation (Next.js,
  React, Vue, etc.)
- **Exa Search (MCP)**: Fast web search for general queries, tutorials, and
  discussions
- **grep.app (MCP)**: Search GitHub for real-world implementation examples
...
1. **CLASSIFY** the query type:
   ...
   - Real-world code examples → Use grep.app
