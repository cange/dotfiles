# Generated by Powerlevel10k configuration wizard on 2023-02-19 at 15:19 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 1704.
...
() {
  ...
  function my_git_formatter() {
    ...
    # icons
    VCS_STATUS_COMMITS_AHEAD_ICON="↑" # ⇡
    VCS_STATUS_COMMITS_BEHIND_ICON="↓" # ⇣
    ...
    VCS_STATUS_STASHES_ICONS=("󰎥 " "󰎨 " "󰎫 " "󰎲 " "󰎯 " "󰎴 " "󰎷 " "󰎺 " "󰎽 " "󰏀 ") # nf-md-numeric_[1-9_plus]_box_multiple_outline

    # ⇣42 if behind the remote.
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${VCS_STATUS_COMMITS_BEHIND}${VCS_STATUS_COMMITS_BEHIND_ICON}"
    # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
    (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${VCS_STATUS_COMMITS_AHEAD}${VCS_STATUS_COMMITS_AHEAD_ICON}"
    # ⇠42 if behind the push remote.
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${VCS_STATUS_PUSH_COMMITS_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${VCS_STATUS_NUM_CONFLICTED_ICON}${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${VCS_STATUS_NUM_STAGED_ICON}${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${VCS_STATUS_NUM_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_VISUAL_IDENTIFIER_EXPANSION='󰎙' # nf-md-nodejs
