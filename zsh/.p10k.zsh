# Generated by Powerlevel10k configuration wizard on 2022-11-04 at 20:47 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    VCS_STATUS_NUM_CONFLICTED_ICON="~"
    VCS_STATUS_NUM_STAGED_ICON=" " # "+"
    VCS_STATUS_NUM_UNSTAGED_ICON=" " # "!"
    ...
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+=" ${untracked}${VCS_STATUS_NUM_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
