...
_cange_source_if_exists "$HOME/.config/secrets/zsh"
# secrets ---
...
_cange_add_plugin "zsh-users/zsh-autosuggestions"
_cange_add_plugin "zsh-users/zsh-syntax-highlighting"

# --- completions
_cange_add_plugin "zsh-users/zsh-completions"
# ZSH https://github.com/zsh-users/zsh-completions
fpath=("$Z_CONFIG_DIR/plugins/zsh-completions/src" $fpath)
# completions ---

# --- prompt theme
_cange_source_if_exists "$Z_CONFIG_DIR/.zshrc" # required by p10k prompt
_cange_add_plugin "romkatv/powerlevel10k"
# prompt theme ---
...
_cange_source_if_exists "$Z_CONFIG_DIR/aliases.git.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/aliases.yarn.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/aliases.docker.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/aliases.pnpm.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/aliases.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/exports.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/fzf.zsh"
_cange_source_if_exists "$Z_CONFIG_DIR/history.zsh"

# https://iterm2.com/documentation-shell-integration.html
_cange_source_if_exists "$Z_CONFIG_DIR/.iterm2_shell_integration.zsh"
